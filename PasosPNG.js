...
webpage.open(url, function (status) {
             ...
             window.setTimeout(function () {
                               webpage.evaluate(function() {
                                                ...
                                                var visualize = $('visualize.panel-content.ng-scope.ng-isolate-scope')[0];
                                                var visContainer = $('div.vis-container')[0];
                                                var visualizeChart = $('div.visualize-chart')[0].outerHTML;
                                                ...
                                                var panelTitle = document.getElementsByClassName('panel-title ng-binding')[0].outerHTML;
                                                ...
                                                webpage.render('Pasos.png', {format: 'png', quality: '50'});
                                                phantom.exit();

...
webpage.open(url, function (status) {
             ...
             window.setTimeout(function () {
                               webpage.evaluate(function() {
                                                ...
                                                var visualize = $('visualize.panel-content.ng-scope.ng-isolate-scope')[2];
                                                var visContainer = $('div.vis-container')[0];
                                                var visualizeChart = $('div.visualize-chart')[2].outerHTML;
                                                visContainer.innerHTML = visualizeChart;
                                                visualize.innerHTML = visContainer.outerHTML;
                                                var panelHeading = document.getElementsByClassName('panel-heading')[2];
                                                var panelTitle = document.getElementsByClassName('panel-title ng-binding')[2].outerHTML;
                                                ...
                                                webpage.render('Actividad.png', {format: 'png', quality: '50'});
                                                phantom.exit();
